...
class S3MonitorSkin extends EventEmitter {
    ...
    _reflowLines () {
        ...
        console.log(`title="${this._title}", titleLineWidth=${titleLineWidth}, valueLineWidth=${valueLineWidth}`)
        console.log(`title="${this._title}", paddedWidth=${paddedWidth}`)
    ...
    _renderTextMonitor (scale) {
        ...
        if(this._visible === true){
            ...
            // Draw value area
            ctx.beginPath();
            const valueAreaHorizonStart = MonitorStyleResized.PADDING + this.titleLineWidth
            const valueHeight = paddedHeight-MonitorStyleResized.PADDING_VALUE_VIRTICAL*2;
            let x00 = valueAreaHorizonStart+MonitorStyleResized.CORNER_RADIUS;
            let y00 = valueHeight+MonitorStyleResized.PADDING_VALUE_VIRTICAL;
            ctx.moveTo(x00, y00);
            let x01_01 = valueAreaHorizonStart;
            let y01_01 = valueHeight+MonitorStyleResized.PADDING_VALUE_VIRTICAL;
            let x01_02 = valueAreaHorizonStart;
            let y01_02 = valueHeight - MonitorStyleResized.CORNER_RADIUS;
            ctx.arcTo(x01_01, y01_01, x01_02, y01_02, MonitorStyleResized.CORNER_RADIUS);
            let x02_01 = valueAreaHorizonStart;
            let y02_01 = MonitorStyleResized.PADDING_VALUE_VIRTICAL;
            let x02_02 = this.valueLineWidth+MonitorStyleResized.CORNER_RADIUS;
            let y02_02 = MonitorStyleResized.PADDING_VALUE_VIRTICAL;
            ctx.arcTo(x02_01,y02_01, x02_02, y02_02, MonitorStyleResized.CORNER_RADIUS);
            let x03_01 = valueAreaHorizonStart+this.valueLineWidth+MonitorStyleResized.PADDING_VALUE_VIRTICAL+MonitorStyleResized.CORNER_RADIUS;
            let y03_01 = MonitorStyleResized.PADDING_VALUE_VIRTICAL;
            let x03_02 = valueAreaHorizonStart+this.valueLineWidth+MonitorStyleResized.PADDING_VALUE_VIRTICAL+MonitorStyleResized.CORNER_RADIUS;
            let y03_02 = valueHeight+MonitorStyleResized.PADDING_VALUE_VIRTICAL;
            ctx.arcTo(x03_01, y03_01, x03_02, y03_02, MonitorStyleResized.CORNER_RADIUS);
            let x04_01 = valueAreaHorizonStart+MonitorStyleResized.PADDING_VALUE_VIRTICAL+this.valueLineWidth+MonitorStyleResized.CORNER_RADIUS;
            let y04_01 = valueHeight+MonitorStyleResized.PADDING_VALUE_VIRTICAL;
            let x04_02 = valueAreaHorizonStart+MonitorStyleResized.PADDING_VALUE_VIRTICAL+MonitorStyleResized.CORNER_RADIUS;
            let y04_02 = valueHeight+MonitorStyleResized.PADDING_VALUE_VIRTICAL;
            ctx.arcTo(x04_01, y04_01, x04_02, y04_02, MonitorStyleResized.CORNER_RADIUS);
            let x05_01 = valueAreaHorizonStart+MonitorStyleResized.CORNER_RADIUS;
            let y05_01 = valueHeight+MonitorStyleResized.PADDING_VALUE_VIRTICAL;
            ...
            ctx.font = `bold ${MonitorStyleResized.FONT_SIZE}px ${MonitorStyle.FONT}, sans-serif`;
            ctx.fillText(
                this._title,
                MonitorStyleResized.CORNER_RADIUS,
                firtLineTop
            ...
            const valueStartPosition = this.titleLineWidth + MonitorStyleResized.PADDING + MonitorStyleResized.CORNER_RADIUS;

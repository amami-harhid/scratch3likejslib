...
const MonitorStyle = {
    MAX_LINE_WIDTH: 170*3, // Maximum width, in Scratch pixels, of a single line of text
...
//            const context = this._canvas.getContext('2d');
    ...
    _reflowLines () {
        ...
        const paddedWidth = Math.max(longestLineWidth, MonitorStyle.MIN_WIDTH) + (MonitorStyle.PADDING * 2) +MonitorStyle.CORNER_RADIUS * 2;

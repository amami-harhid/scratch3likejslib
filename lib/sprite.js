...
//        }
    ...
    get Motion() {
        return {
            ...
            "moveTo" : this.moveTo,
            "ifOnEdgeBounds" : this.ifOnEdgeBounds,
            "gotoRandomPosition": this.gotoRandomPosition,
            "gotoMousePosition" : this.gotoMousePosition,
            "gotoSprite" : this.gotoSprite,
            "glideToPosition": this.glideToPosition,
            /** マウスの位置へ向く */
            "pointToMouse" : this.pointToMouse,
            /** 指定したターゲットの位置へ向く */
            "pointToTarget" : this.pointToTarget,
            /** 角度を指定して向きを変える */
            "pointInDerection" : this.pointInDerection,
            /** 回転方法を指定する */
            "setRotationStyle" : this.setRotationStyle,
            //--- Entity
    ...
    get Looks(){
        return {
            "nextCostume": this.nextCostume,
            "switchCostume": this.switchCostume,
            "say": this.say,
            "sayForSecs": this.sayForSecs,
            "think": this.think,
            "thinkForSecs": this.thinkForSecs,
            "changeSizeBy" : this.changeSizeBy,
            "setScale" : this.setScale,
            "changeEffectBy": this.changeEffectBy,
            "setEffectTo": this.setEffectTo,
            "clearEffects": this.clearEffect,
            "show": this.show,
            "hide": this.hide,
            "goToFront": this.goToFront,
            "goToBack": this.goToBack,
            "goForwardLayers": this.goForwardLayers,
            "goBackwardLayers": this.goBackwardLayers,
    ...
    get Sensing() {
        return {
            ...
            "isTouchingEdge" : this.isTouchingEdge,
            "isTouchingVirticalEdge" : this.isTouchingVirticalEdge,
            "isTouchingHorizontalEdge" : this.isTouchingHorizontalEdge,
            "isNotMouseTouching" : this.isNotMouseTouching,
            "isMouseTouching": this.isMouseTouching,
            "isTouchingTargetToTarget": this.isTouchingTargetToTarget,
            "getTouchingTarget": this.getTouchingTarget,
        }
    }
    get E() {
        return this.Events;
    ...
    get Events() {
        return {
            ...
            "broadcastAndWait" : this.broadcastAndWait,
            "broadcastToTargets": this.broadcastToTargets,
            "broadcastAndWaitToTargets": this.broadcastAndWaitToTargets,
            "whenBroadcastReceived": this.whenBroadcastReceived,
            "whenRightNow": this.whenRightNow,
            "whenFlag": this.whenFlag,
            "whenKeyPressed": null, // Entity 工事中
            "whenMouseTouched": this.whenMouseTouched,
            "whenTargetMouseTouched": this.whenTouchingTarget,
            "whenCloned": this.whenCloned,
    ...
    get Sound() {
        return {
            ...
            "setSoundPitch" : this.setSoundPitch,
            "stopSound": this.soundStop,
            "stopSoundImmediately": this.soundStopImmediately,

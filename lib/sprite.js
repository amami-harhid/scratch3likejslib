...
//        }
    ...
    get Motion() {
        return {
            ...
            "direction": this.setDirection.bind(this),
    ...
    get Sound() {
        return {
            ...
            //---Entity
            "soundSwitch" : this.soundSwitch.bind(this),
            "nextSound" : this.nextSound.bind(this),
            "soundPlay" : this.soundPlay.bind(this),
            "setSoundVolume" : this.setSoundVolume.bind(this),
            "setSoundPitch" : this.setSoundPitch.bind(this),
            "stopSound": this.soundStop.bind(this),
            "stopSoundImmediately": this.soundStopImmediately.bind(this),

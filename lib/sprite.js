...
const Sprite = class extends Entity {
    ...
    */
    ...
    async $addSound(soundData, options = {}) {
        if(soundData == undefined || soundData['name'] == undefined || soundData['data'] == undefined ){
            throw "【Sprite.addSound】正しいサウンドデータを指定してください"
        }
        if(this.soundDatas){
    ...
    async $addImage(imageData) {
        if(imageData == undefined || imageData['name'] == undefined || imageData['data'] == undefined ){
            throw "【Sprite.addImage】正しいイメージデータを指定してください"
        }
        if( this.imageDatas) {
    ...
    get Looks(){
        return {
            ...
            "getSelfDimensions":this.$getDrawingDimensions.bind(this),

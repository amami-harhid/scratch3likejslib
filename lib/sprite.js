    ...
    */
    ...
    async $addSound(soundData, options = {}) {
        ...
        if(soundData == undefined ){
            throw "【Sprite.Sound.add】イメージデータの指定がありません"
        }else if(soundData == undefined || typeof soundData == "string"){
            _soundData = PlayGround.default.loadedSounds[imageData];
            if(_soundData == undefined){
                throw "【Sprite.Sound.add】正しいイメージ名を指定してください"
            }
        }else{

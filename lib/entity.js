    ...
    $whenClicked (func) {
        ...
        const eventf = async (e, _counter)=>{
            ...
            if(me.drawableID == _touchDrawableId){
                // 前回のクリック分を止める。
                console.log(`removeObjById, entityId=${entityId}, CLICK_COUNTER=${CLICK_COUNTER}`);

...
const Entity = class extends EventEmitter{
    ...
    async $setOption(key, value) {
        ...
        // 1FPS分待つことで解消させる
        await Libs.default.wait(1000/33);
    }
...
//        flag.removeEventListener('click', clickFunc);
    ...
    */
    ...
    startThread( func, entity , doubleRunable=true) {
        console.log(func);
        if( FunctionChecker.isArrowFunction(func) ){
            // アロー関数は許可しない
        ...
        // const src = 'return async function*(){await func();}';
        // const f = new Function(['func', 'entity'], src);
        // const gen = f( func.bind(_entity),  _entity );
        // obj.f = gen();
        obj.f = func.bind(_entity)(); // bindした後に Generateする
        obj.originalF = func;

...
const Monitor = class {
    ...
    init() {
        ...
        const scratch_rect_size = p.toScratchPosition(original_rect.width, original_rect.height);
...
*/
            ...
            listeners: {
                ...
                move(event) {
                    ...
                    const actualPosition = p.toActualPosition(scratchX, scratchY);
                    ...
                    const dScratchPosition = p.toScratchPosition(  actualPosition.x, actualPosition.y );

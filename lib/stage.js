...
//            s.z = ++_z;
    ...
    get Looks(){
        return {
            "nextBackdrop": this.nextCostume,       // Sprite-->Entityへ
            "switchBackdrop": this.switchCostume,   // Sprite-->Entityへ
            "changeEffectBy": this.changeEffectBy,  // Sprite-->Entityへ
            "setEffectTo": this.setEffectTo,        // Sprite-->Entityへ
            "clearEffects": this.clearEffect,       // Sprite-->Entityへ
    ...
    get Control() {
        return {
            "wait" : this.waitSeconds,    // Sprite --> Entityへ
            "waitUntil": this.waitUntil,  // Sprite --> Entityへ
            "waitWhile": this.waitWhile,  // Sprite --> Entityへ
            //---- Entity
            "forever": this.while,
            "repeat": this.repeat,
